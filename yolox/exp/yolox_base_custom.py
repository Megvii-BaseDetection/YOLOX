...
class CustomExp(BaseExp):
    def __init__(self):
        ...
        self.data_dir = str(Path(__file__).parent.parent.parent / 'datasets')
    ...
    def get_data_loader(self, batch_size, is_distributed, no_aug=False):
        from yolox.data import (CustomDataset, DataLoader, InfiniteSampler,
    ...
    def get_eval_loader(self, batch_size,
                        is_distributed,
                        testdev=False):
        from yolox.data import CustomDataset, ValTransform
    ...
    def get_evaluator(self, batch_size, is_distributed, testdev=False):
        from yolox.evaluators import CustomEvaluator
