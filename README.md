...
To log metrics, predictions and model checkpoints to [W&B](https://docs.wandb.ai/) use the command line argument `--logger wandb` and use the prefix "wandb-" to specify arguments for initializing the wandb run.
